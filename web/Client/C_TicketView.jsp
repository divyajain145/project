    ...
    <body>
        <%
            ...
            try {
                if (request.getParameter("send") != null) {
                    ...
                    int val = tm.ticket_reply_master_ClassInsert(ticket_id, user_id, sender_id, msg);
                    if (val > 0) {
                        out.print("<script>alert('successfully reply sent');window.location.href='Client.jsp?page=C_Master.jsp?page1=C_TicketView.jsp&ticket_id=" + request.getParameter("ticket_id") + "';</script>");
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="text" id="department" name="department" value="<%=rs.getString("Support_Type")%>" disabled>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    ...
                    <input type="text" id="priority" name="priority" value="<%=rs.getString("Priority")%>" disabled>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <textarea style="height:100px" id="msg" name="msg" disabled><%=rs.getString("Message")%></textarea>
                </div>
            </div>
        </div>
        <%
        ...
        <div class="row bootstrap snippets ">
            <div class="col-75" style="margin-top: 50px; margin-left: 14%;">
                <!-- DIRECT CHAT PRIMARY -->
