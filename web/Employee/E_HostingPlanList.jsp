...
<%
    ...
    if (request.getParameter("Delete") != null) {
        ...
        if(val > 0)
        {
            out.print("<script>alert('Succesfully Delete Your Data.'); window.location.href='Employee.jsp?page=E_HostingPlanList.jsp';</script>");
        }
    }
...
<html>
    ...
    <body>
        ...
        <h4 class="clearfix">
            Hosting Plan
            <a href="Employee.jsp?page=E_HostingPlanForm.jsp" class="btn btn-primary float-right"><i class="fa fa-plus"></i> Add</a>
        </h4>
        <hr>
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    %>
                    <tr>
                        <td><a href="Employee.jsp?page=E_HostingPlanForm.jsp?edit=<%=rs.getString("hp_id")%>"><i class="fa fa-pen"></i></a></td>
                        <td><a href="Employee.jsp?page=E_HostingPlanList.jsp?Delete=<%=rs.getString("hp_id")%>" onclick="return confirm('Are you sure you want to delete data?')"><i class="fa fa-trash"></i></a></td>
