...
<html>
    ...
    <body>
            ...
            if (request.getParameter("btn1") != null) {
                ...
                if (val > 0) {
                    if (request.getParameter("edit") != null) {
                        ...
                        out.print("<script>alert('Successfully Update Your Data.');window.location.href='Employee.jsp?page=E_DomainForm.jsp';</script>");
                    } else {
                        if (val == 2) {
                            String a = request.getParameter("txtTech") + " already Exists";
                            out.print("<script>alert('" + a + "');</script>");
        ...
        <form action="E_DomainForm.jsp <% if (request.getParameter("edit") != null) {
            ...
            <h4 class="clearfix">
                Domain
                <a href="Employee.jsp?page=E_DomainList.jsp" class="btn btn-primary float-right"><i class="fa fa-angle-left"></i> Back</a>
            </h4>
            <hr>
            <div class="card">
