        ...
        if (val > 0) {
            if (request.getParameter("edit") != null) {
                if (val == 2) {
                    ...
                    out.print("<script>alert('Successfully Updated Your Data.');window.location.href='Employee.jsp?page=E_FAQForm.jsp';</script>");
                }
            } else {
                if (val == 2) {
                    String a = request.getParameter("txtQue") + " already Exists";
...
<html>
    ...
    <body>
        ...
        <form action="E_FAQForm.jsp <% if (request.getParameter("edit") != null) {
            ...
            <h4 class="clearfix">
                FAQ's
                <a href="Employee.jsp?page=E_FAQList.jsp" class="btn btn-primary float-right"><i class="fa fa-angle-left"></i> Back</a>
            </h4>
            <hr>
            <div class="card">
