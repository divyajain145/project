...
<html>
    ...
    <body>
        <%
            String sub_name=request.getParameter("subdomain");
            String d_name = "";
                                    ...
                                    <div class="dd" id="nestable">
                                        <ol class="dd-list">
                                            ...
                                            <li class="dd-item" data-id="2"><button class="dd-collapse" data-action="collapse" type="button">Collapse</button><button class="dd-expand" data-action="expand" type="button">Expand</button>
                                                <div class="dd-handle"><%=sub_name%> </div>

                                                <%

                                                    File folder1 = new File(p + "/www." + rs.getString("Domain_Name")+"/subdomain/"+sub_name);
                                                                ...
                                                                <table id="datable_1" class="table table-hover w-100 display pb-30 dataTable dtr-inline" role="grid" aria-describedby="datable_1_info">
                                                                    ...
                                                                    <tbody>
                                                                        <%
                                                                            ...
                                                                            File folder2 = new File(p + "/www." + rs.getString("Domain_Name")+"/subdomain/"+sub_name);
                                                                        ...
                                                                        <tr role="row" class="odd">
                                                                            <td tabindex="0" class="sorting_1">
                                                                                <div class="col-md-1 mt-1">
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" name="check" value="<%=f2.getName()%>" class="custom-control-input" id="<%=f2.getName()%>">
                                                                                        <label class="custom-control-label mb-25" for="<%=f2.getName()%>"></label>

                                                                                    </div>
                                                                                </div>
                                                                            </td>

                                                                            <td class="col-9"><i class="fa fa-folder"></i><a href="" style="color: #0090cf;"> <%=f2.getName()%></a></td>
